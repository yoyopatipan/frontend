<template>
  <div>
    ...
    >
      <div class="px-3 py-2">
        <b-nav vertical>
          <b-nav-item href="http://localhost:3000/guest/home"
            ><p class="a">หน้าแรก</p></b-nav-item
          >
          <!-- b-nav-item ไม่มี property style color -->

          <b-nav-item href="http://localhost:3000/guest/aboutus"
          ...
          <b-navbar toggleable type="dark">
            ...
            <b-collapse id="navbar-toggle-collapse1" is-nav>
              <b-navbar-nav class="g">
                <b-nav-item href="http://localhost:3000/guest/detectdiabetes"
                  ><p class="f">ประเมินความเสี่ยงโรคเบาหวาน</p></b-nav-item
                >
                <b-nav-item href="http://localhost:3000/guest/detectheart"
          ...
          <b-navbar toggleable type="dark">
            ...
            <b-collapse id="navbar-toggle-collapse2" is-nav>
              <b-navbar-nav class="g">
                <b-nav-item href="http://localhost:3000/guest/diabetesinfo"
                  ><p class="f">ข้อมูลโรคเบาหวาน</p></b-nav-item
                >
                <b-nav-item href="http://localhost:3000/guest/heartinfo"
          ...
          <b-nav-item href="http://localhost:3000/guest/game"
            ><p class="a">เกมส์ตอบคำถาม</p></b-nav-item
          >
          <b-nav-item href="http://localhost:3000/guest/login"
            ><p class="a">เข้าสู่ระบบ</p></b-nav-item
          >
          <b-nav-item href="http://localhost:3000/guest/register"
